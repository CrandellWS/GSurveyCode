    ...
    <div class="register-box-body">
        ...
        <form  method="post">
            <div class="form-group has-feedback">
                <input type="text" name="name" value="${name}" class="form-control" placeholder="Full name" disabled>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="email" name="email" value="${email}" class="form-control" placeholder="Email" disabled>
