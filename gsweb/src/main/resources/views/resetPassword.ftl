<#-- @ftlvariable name="" type="views.resetPassword" -->
<!DOCTYPE html>
    ...
    <div class="register-box-body">
        ...
        <form id="registerForm" method="post">
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button id="submit" type="submit" class="btn btn-primary btn-block btn-flat">Send</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
...
<script>
    ...
    onload = function () {
        ...
        form.addEventListener("submit", function (evt) {
            ...
            var form = document.getElementById('registerForm');
            fetch('${basePath}register/resetPassword', {
                method: 'post',
                headers: {
                    'Accept': 'text/html',
