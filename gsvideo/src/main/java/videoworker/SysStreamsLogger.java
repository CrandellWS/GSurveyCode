...
public class SysStreamsLogger {
    private static Logger sysOutLogger = LoggerFactory.getLogger(LogbackFileUtils.MY_LOGGER);
    private static Logger sysErrLogger = LoggerFactory.getLogger(LogbackFileUtils.MY_LOGGER);
